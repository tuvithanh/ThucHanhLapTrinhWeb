...
namespace _23DH113217_MyStore.Models.ViewModel
{
    ...
    public class Cart
    {
        ...
        public
        IEnumerable<CartItem> Items => items;
        ...
        {
            var existingItem = items.FirstOrDefault(i => i.ProductID == productId); if (existingItem == null)
            {
        ...
        {
            var item = items.FirstOrDefault(i => i.ProductID == productId); if (item != null)
            {
